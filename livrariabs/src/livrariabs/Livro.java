...
public class Livro extends Produto {
	...
	public Livro(String descricao, String genero, int estoque, float custo, float venda, String autor, String editora, String edicao) {
